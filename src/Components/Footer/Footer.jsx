            ...
            <footer className="flex flex-col md:flex-row items-center justify-center px-6 md:px-20 pb-8">
                ...
                <nav className="flex flex-col items-center  text-center md:text-right">
                    ...
                    <div className="flex gap-6 mt-3">
                        ...
                        <a href="https://www.linkedin.com/in/fazlullah-tamim-27896633a/" target="_blank" rel="noopener noreferrer">
                            <img src="https://img.icons8.com/ios-filled/28/linkedin.png" alt="LinkedIn" />
                        </a>
                    </div>
                </nav>
            </footer>
